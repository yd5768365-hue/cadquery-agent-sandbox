...
一个基于 Cherry Studio 构建的高度工程化 AI Agent 系统，专注于 CadQuery 参数化建模。系统通过 MCP (Model Context Protocol) 提供工具化接口，让智能体能安全地读取/写入文件、运行代码并在受控的 Docker 沙盒中执行反馈循环，从而自动修复错误并迭代生成可靠的 CAD 脚本。
